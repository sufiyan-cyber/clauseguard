/**
 * Icon system — Lucide-style SVG set (24×24 grid, stroke 2, round caps).
 * One family, one stroke width, sized via the `size` prop; color inherits
 * currentColor so semantic tokens drive theming. Never emoji.
 */
